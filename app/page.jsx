  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-black to-pink-900 text-white overflow-hidden relative">
      ...
      <AnimatePresence mode="wait">
        ...
        {/* ИСПРАВЛЕННЫЙ БЛОК НАСТРОЙКИ С ПРОКРУТКОЙ */}
        {step === "setup" && (
          <motion.div
            key="setup"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            // Ключевые стили для прокрутки: fixed inset-0 и overflow-y-auto
          ...
          >
            <div className="flex min-h-screen flex-col items-center justify-start p-6 pt-20 pb-40">
